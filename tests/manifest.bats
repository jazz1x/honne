...
@test "pre-commit rejects SKILL.md whose name contains a colon" {
  ...
  # Inject a bad skill and stage it.
  mkdir -p skills/_regressiontest
  cat > skills/_regressiontest/SKILL.md <<'EOF'
---
name: honne:bogus
version: 0.0.1
description: should be rejected — name contains colon
---
body
EOF
  git add skills/_regressiontest/SKILL.md
